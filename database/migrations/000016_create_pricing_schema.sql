-- 000016_create_pricing_schema.sql
...
ADD CONSTRAINT transaction_items_promotion_id_fkey
FOREIGN KEY (promotion_id) REFERENCES pricing.promotions(id) ON DELETE RESTRICT;
